...
app.get('/', (req, res) => {
  res.send('Welcome to the Activity API! Use /random to get a random activity or /filter to filter activities by type and participants.');
});
...
// Route to retrieve activities of a certain type
app.get('/filter', (req, res) => {
  ...
  if (filteredActivities.length > 0) {
    ...
    res.status(404).json({ error: 'Activities not found for the given filter.' });
  }
});
